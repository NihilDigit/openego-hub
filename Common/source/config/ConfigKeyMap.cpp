...
const std::pair<ConfigKeyId, std::string_view> kStaticKeyMap[] = {
    ...
    {ConfigKeyId::TouchPeakDetectionClosePeakMinSaddleDrop, "touch.peak_detection.close_peak_min_saddle_drop"},
    {ConfigKeyId::TouchPeakDetectionClosePeakMinSaddleRatio, "touch.peak_detection.close_peak_min_saddle_ratio"},
    ...
    {ConfigKeyId::TouchZoneContactTouchSizeFallbackMm, "touch.zone_contact.touch_size_fallback_mm"},
    {ConfigKeyId::TouchZoneContactTouchSizeAreaScale, "touch.zone_contact.touch_size_area_scale"},
    {ConfigKeyId::TouchZoneContactTouchSizeSignalScale, "touch.zone_contact.touch_size_signal_scale"},
    {ConfigKeyId::TouchZoneContactTouchSizeRowPitchMm, "touch.zone_contact.touch_size_row_pitch_mm"},
    {ConfigKeyId::TouchStrokeEnabled, "touch.stroke.enabled"},
    {ConfigKeyId::TouchStrokeContinueMaxGapMs, "touch.stroke.continue_max_gap_ms"},
    {ConfigKeyId::TouchStrokeContinueMaxDistanceCells, "touch.stroke.continue_max_distance_cells"},
    {ConfigKeyId::TouchStrokeContinueMinSizeRatio, "touch.stroke.continue_min_size_ratio"},
    {ConfigKeyId::TouchStrokeContinueMaxSizeRatio, "touch.stroke.continue_max_size_ratio"},
    {ConfigKeyId::TouchStrokeHoldMinPeakSignal, "touch.stroke.hold_min_peak_signal"},
    ...
    {ConfigKeyId::TouchPalmBoxEnabled, "touch.palm_box.enabled"},
    {ConfigKeyId::TouchPalmBoxExpandRows, "touch.palm_box.expand_rows"},
    {ConfigKeyId::TouchPalmBoxExpandCols, "touch.palm_box.expand_cols"},
    {ConfigKeyId::TouchPalmBoxMatchCenterDistance, "touch.palm_box.match_center_distance"},
    {ConfigKeyId::TouchPalmBoxMatchIouThreshold, "touch.palm_box.match_iou_threshold"},
    {ConfigKeyId::TouchPalmBoxPalmLikelyOnly, "touch.palm_box.palm_likely_only"},
    {ConfigKeyId::TouchPalmBoxKeepUntilNoPeakDomainInside, "touch.palm_box.keep_until_no_peak_domain_inside"},
    {ConfigKeyId::TouchPalmBoxMaxHoldFrames, "touch.palm_box.max_hold_frames"},
    ...
    {ConfigKeyId::StylusSpTiltCalibOffset, "stylus.sp.tilt_calib_offset"},
    {ConfigKeyId::StylusSpTiltCalibScale, "stylus.sp.tilt_calib_scale"},
    {ConfigKeyId::StylusSpTiltMaxDiffJump, "stylus.sp.tilt_max_diff_jump"},
};
